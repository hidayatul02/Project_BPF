...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bground_1.jpg'); ?>');">
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/abaout.jpg'); ?>);">
            ...
            <div class="heading-section-bold mb-4 mt-md-5">
                <div class="ml-md-0">
                  <h2 class="mb-4">Selamat Datang di Toko Online Toko Elektronik</h2>
              </div>
            </div>
            <div class="pb-md-5">
                <p>Belanja Barang - Barang Elektronik Lebih Murah</p>
                          <p><a href="<?php echo site_url('browse'); ?>" class="btn btn-secondary">Belanja sekarang!</a></p>
                      </div>
                  </div>
              </div>
          </div>
