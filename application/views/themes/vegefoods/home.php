...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bground_1.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Hanya Menjual Elektronik</h1>
            <h2 class="subheading mb-4">Mulai dari peralatan Rumah Tangga</h2>
            <p><a href="#products" class="btn btn-secondary">Belanja Sekarang</a></p>
          </div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bground_2.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Barang Berkualitas</h1>
            <h2 class="subheading mb-4">Barang Elektronik Langsung dari Pabrik</h2>
            <p><a href="#products" class="btn btn-secondary">Belanja Sekarang</a></p>
          </div>
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4">Toko Elektronik</h2>
      <p>Belanja Barang Elektronik murah dan berkualitas</p>
    </div>
  </div>   		
  </div>
  <div class="container">
  ...
  <div class="container">
    ...
    <h3>Produk dengan harga terbaik</h3>
